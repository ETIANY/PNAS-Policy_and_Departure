...
df = pd.read_csv('6-2_all.csv', header=None, encoding='utf-8')
...
for name, group in grouped:
    # Check that all of the author's works have a value of 5 or less in column 23
    if (group[22] <= 5).all():
...
selected_rows.to_csv('7-2_all.csv', index=False, header=False, encoding='utf-8')